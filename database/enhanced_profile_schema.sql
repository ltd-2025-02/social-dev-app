...
-- This schema extends the existing profile system with comprehensive user data
...
-- Atualizar tabela de perfis existente
...
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS availability VARCHAR(50);
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS hourly_rate DECIMAL(10,2);
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS years_of_experience INTEGER DEFAULT 0;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS open_to_work BOOLEAN DEFAULT FALSE;
ALTER TABLE user_profiles ADD COLUMN IF NOT EXISTS preferred_work_type VARCHAR(50);
